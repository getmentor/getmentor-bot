...
const foodMenu = new MenuTemplate<MentorContext>('People like food. What do they like?')
...
function personButtonText(_: MentorContext, key: string): string {
...
function foodSelectText(ctx: MentorContext): string {
...
const foodSelectSubmenu = new MenuTemplate<MentorContext>(foodSelectText)
...
const mediaMenu = new MenuTemplate<MentorContext>(() => {
